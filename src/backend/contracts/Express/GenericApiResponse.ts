...
export default class GenericApiResponse {
    ...
    static badRequest<ResBody>(res: Response, body:ResBody): AppResponse<ResBody> {
    ...
    static unAuthorized<ResBody>(res: Response, body:ResBody): AppResponse<ResBody> {
    ...
    static forbidden<ResBody>(res: Response, body:ResBody): AppResponse<ResBody> {
    ...
    static serverError<ResBody>(res: Response, body:ResBody): AppResponse<ResBody> {
