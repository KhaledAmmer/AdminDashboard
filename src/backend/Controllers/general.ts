...
import { UserGetOneRequestDto, UserGetOneResponseDto } from '../contracts/User/UserGetOneDto';
...
export const getUser = async (
  ...
  try {
    const user : UserGetOneResponseDto | null = await User.findById(req.params.id);
